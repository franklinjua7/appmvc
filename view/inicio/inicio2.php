  ...
  <aside class="main-sidebar">
    ...
    <section class="sidebar">
      ...
      <ul class="sidebar-menu" data-widget="tree">
        ...
        <li class="active"><a href="?c=Libro&a=Index"><i class="fa fa-link"></i> <span>LIBROS</span></a></li>
        <li><a href="?c=Autor&a=Index"><i class="fa fa-link"></i> <span>AUTORES</span></a></li>
        <li><a href="?c=Genero&a=Index"><i class="fa fa-link"></i><span>GENEROS</span></a></li>
        <li><a href="?c=Editorial&a=Index"><i class="fa fa-link"></i><span>EDITORIALES</span></a></li>
        <li class="treeview">
          ...
          <?php
            ...
            # En este caso solo tendran acceso los ALUMNOS
          ?>
            <ul class="treeview-menu">
